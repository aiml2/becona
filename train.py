...
##CALLBACKS
#checkpoint callback
checkpointer = ModelCheckpoint(filepath='/tmp/w-dense256-s-valtraingen-BECONA-4.4.hdf5', verbose=1, save_best_only=True)
#early stopping too;
...
model.save('BECONA-D256-s-valtraingen-coarse-10ep-4.4.h5')
...
model.save('BECONA-D256-s-valtraingen-finetuned-10ep-4.4.h5')
...
model.save('BECONA-D256-s-valtraingen-finetuned-20ep-4.4.h5')
