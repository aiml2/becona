...
class FTMC_InceptionV3_v1(AbstractFineTuneModelConfig):
    dataSetVersion=0.1 #Uncropped dataset
    configId="-mIV3_v1"
    #dataDirPrefix='split'
...
#Start with base model, without last layer.
        self.baseModel = InceptionV3(weights='imagenet', include_top=False)
...
# Same fit_generator?
        ...
        self.model.save(savename.format(epoch=10))
        ...
        self.model.save(savename.format(epoch=20))
