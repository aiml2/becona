...
#Same as InceptionV3 but with Adam for all epochs
class FTMC_InceptionV3_v7(AbstractFineTuneModelConfig):
...
#Start with base model, without last layer.
        self.baseModel = InceptionV3(input_shape=self.input_shape, weights='imagenet', include_top=False)
